...
<!---->
 <script type="text/javascript" src="//maps.google.com/maps/api/js?sensor=true"></script>
  <script type="text/javascript" src="<?php echo base_url(); ?>dist/js/gmaps.js"></script>
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>dist/css/examples.css" />
</head>
<body>
<div id="wrapper">
        <!----->
