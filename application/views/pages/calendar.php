...
<div id="wrapper">
 	...
 	<!--banner-->	
		    <div class="banner">
		    	<h2>
				<a href="<?php site_url('welcome/index'); ?>">Home</a>
...
<!---->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>dist/css/calendar.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>dist/css/custom_1.css" />
		<script type="text/javascript" src="<?php echo base_url(); ?>dist/js/jquery.calendario.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>dist/js/data.js"></script>
