 	...
 	<!--banner-->	
 	 ...
 	 <div class="gallery">
 	 	<div class="col-md">
 	 		...
 	 		<a href="<?php echo base_url(); ?>dist/images/ga.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title" >
				 <img class="img-responsive " src="<?php echo base_url(); ?>dist/images/ga.jpg" alt="" />   
 	 	...
 	 	<div class="col-md">
 	 		<div class="gallery-img">
 	 		<a href="<?php echo base_url(); ?>dist/images/ga1.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title" >
				 <img class="img-responsive " src="<?php echo base_url(); ?>dist/images/ga1.jpg" alt="" />   
					<span class="zoom-icon"> </span> </a>
			</a>
			</div>	
 	 		<div class="text-gallery">
 	 	...
 	 	<div class="col-md">
 	 		<div class="gallery-img">
 	 		<a href="<?php echo base_url(); ?>dist/images/ga2.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title" >
				 <img class="img-responsive " src="<?php echo base_url(); ?>dist/images/ga2.jpg" alt="" />   
					<span class="zoom-icon"> </span> </a>
			</a>
			</div>	
 	 		<div class="text-gallery">
 	 	...
 	 	<div class="col-md">
 	 		<div class="gallery-img">
 	 		<a href="<?php echo base_url(); ?>dist/images/ga3.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title" >
				 <img class="img-responsive " src="<?php echo base_url(); ?>dist/images/ga3.jpg" alt="" />   
					<span class="zoom-icon"> </span> </a>
			</a>
			</div>	
 	 		<div class="text-gallery">
 	 	...
 	 	<div class="col-md">
 	 		<div class="gallery-img">
 	 		<a href="<?php echo base_url(); ?>dist/images/ga4.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title" >
				 <img class="img-responsive " src="<?php echo base_url(); ?>dist/images/ga4.jpg" alt="" />   
					<span class="zoom-icon"> </span> </a>
			</a>
			</div>	
 	 		<div class="text-gallery">
 	 	...
 	 	<div class="col-md">
 	 		<div class="gallery-img">
 	 		<a href="<?php echo base_url(); ?>dist/images/ga5.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title" >
				 <img class="img-responsive " src="<?php echo base_url(); ?>dist/images/ga5.jpg" alt="" />   
					<span class="zoom-icon"> </span> </a>
			</a>
			</div>	
 	 		<div class="text-gallery">
 	 	...
 	 	<div class="col-md">
 	 		<div class="gallery-img">
 	 		<a href="<?php echo base_url(); ?>dist/images/ga6.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title" >
				 <img class="img-responsive " src="<?php echo base_url(); ?>dist/images/ga6.jpg" alt="" />   
					<span class="zoom-icon"> </span> </a>
			</a>
			</div>	
 	 		<div class="text-gallery">
 	 	...
 	 	<div class="col-md">
 	 		<div class="gallery-img">
 	 		<a href="<?php echo base_url(); ?>dist/images/ga7.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title" >
				 <img class="img-responsive " src="<?php echo base_url(); ?>dist/images/ga7.jpg" alt="" />   
					<span class="zoom-icon"> </span> </a>
			</a>
			</div>	
 	 		<div class="text-gallery">
 	 	...
 	 	<div class="col-md">
 	 		<div class="gallery-img">
 	 		<a href="<?php echo base_url(); ?>dist/images/ga8.jpg" class="b-link-stripe b-animate-go  swipebox"  title="Image Title" >
				 <img class="img-responsive " src="<?php echo base_url(); ?>dist/images/ga8.jpg" alt="" />   
					<span class="zoom-icon"> </span> </a>
			</a>
			</div>	
 	 		<div class="text-gallery">
...
<!---->
<link rel="stylesheet" href="<?php echo base_url(); ?>dist/css/swipebox.css">
	<script src="<?php echo base_url(); ?>dist/js/jquery.swipebox.min.js"></script> 
